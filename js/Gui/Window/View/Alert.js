...
Gui.Window.View.Alert.prototype.addMessage = function () {
    ...
    this.message = $('<div class="alert-message">').text(App.core.translate(this.data.message)).appendTo(this.body);
...
Gui.Window.View.Alert.prototype.addInfo = function () {
    ...
    $('<div class="alert-info">').text(App.core.translate(this.data.info)).appendTo(this.message);
