 ...
 * @returns {Date}
 */
App.Helper.prototype.now = function () {
 ...
 * @return {*}
 */
App.Helper.prototype.getTimeString = function (date) {
 ...
 */
App.Helper.prototype.getDateString = function (date, fullYear) {
 ...
 * @return {*}
 */
App.Helper.prototype.getDateTimeString = function (date, fullYear) {
    if (date instanceof Date) {
 ...
 * @return {Date|Boolean}
 */
App.Helper.prototype.strToDate = function (time, reg) {
 ...
 * @return {String}
 */
App.Helper.prototype.pad = function (n, width, z) {
 ...
 * @return {String}
 */
App.Helper.prototype.getDurationAsString = function (duration) {
 ...
 * @return {string|boolean}
 */
App.Helper.prototype.getWeekDay = function (date, abbr) {

	if (date instanceof Date) {

		return abbr
            ? App.core.translate(this.weekDays[date.getDay()]).substr(0,2)
            : App.core.translate(this.weekDays[date.getDay()]);
	}
	return false;
};

App.Helper.prototype.weekDays = [
 ...
 */
App.Helper.prototype.log = function () {

    if (App.config.getItem('debug')) {
 ...
 * @return {*}
 */
App.Helper.prototype.vdrDecodeURI = function (string) {
 ...
 * @returns {number}
 */
App.Helper.prototype.sortAlpha = function (a, b) {
 ...
 * @returns {*}
 */
App.Helper.prototype.parseDescription = function (description) {
